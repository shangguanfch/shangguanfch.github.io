...
- [Git](https://git-scm.com/) (and complete [First-Time Git Setup](https://git-scm.com/book/en/v2/Getting-Started-First-Time-Git-Setup))
...
It's easy to use [hexo-deployer-git](https://github.com/hexojs/hexo-deployer-git) to complete deployment (find other deployer plugins at: ~~https://hexo.io/docs/deployment.html~~ (not available now), please visit https://hexo.io/docs/github-pages).
...
However, if you use Linux, you may prefer create a shell script, or edit `.zshrc` (or `.bashrc`, etc.).
...
## Upgrade
My Hexo blog is out of style, it needs upgrade.
...
gulp-clean-css            3.10.0  3.10.0   4.3.0  hexo-site
gulp-htmlmin               3.0.0   3.0.0   5.0.1  hexo-site
gulp-imagemin              3.4.0   3.4.0   7.1.0  hexo-site
hexo                       3.9.0   3.9.0   5.2.0  hexo-site
...
hexo-renderer-ejs          0.2.0   0.2.0   1.0.0  hexo-site
hexo-renderer-marked      0.2.11  0.2.11   3.3.0  hexo-site
hexo-renderer-stylus       0.3.3   0.3.3   2.0.1  hexo-site
hexo-server                0.2.2   0.2.2   2.0.0  hexo-site
hexo-symbols-count-time    0.2.0   0.2.0   0.7.1  hexo-site
hexo-wordcount             3.0.2   3.0.2   6.0.1  hexo-site
```
```
